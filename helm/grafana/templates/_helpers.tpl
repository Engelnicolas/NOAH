...
runAsNonRoot: true
runAsUser: {{ .Values.securityContext.runAsUser | default 472 }}
runAsGroup: {{ .Values.securityContext.runAsGroup | default 472 }}
fsGroup: {{ .Values.securityContext.fsGroup | default 472 }}
seccompProfile:
  type: RuntimeDefault
{{- end }}
